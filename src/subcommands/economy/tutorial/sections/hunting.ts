    ...
    return {
      ...
      description: stripIndents`
        **This is a big part of the bot, so you might want to pay attention.**
        ...
        Hunting is the main source of eating when using Vorasion. Every hunt is associated with a minigame. Right now, you'll only be able
        ...
        - \`/economy eat\` -> This is the PvP command, where you go after another player and try to swallow them. But if you fail... you're dinner for them.
